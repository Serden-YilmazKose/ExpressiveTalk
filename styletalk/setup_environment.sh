...
apt-get update
apt-get install -y build-essential cmake libgl1-mesa-glx libglib2.0-0 ffmpeg
...
echo "Getting scripts from PIRender repo..."
wget "https://raw.githubusercontent.com/RenYurui/PIRender/refs/heads/main/scripts/face_recon_videos.py" -O "./Deep3DFaceRecon_pytorch/face_recon_videos.py"
wget "https://raw.githubusercontent.com/RenYurui/PIRender/refs/heads/main/scripts/extract_kp_videos.py" -O "./Deep3DFaceRecon_pytorch/extract_kp_videos.py"
wget "https://raw.githubusercontent.com/RenYurui/PIRender/refs/heads/main/scripts/coeff_detector.py" -O "./Deep3DFaceRecon_pytorch/coeff_detector.py"
wget "https://raw.githubusercontent.com/RenYurui/PIRender/refs/heads/main/scripts/inference_options.py" -O "./Deep3DFaceRecon_pytorch/options/inference_options.py"
